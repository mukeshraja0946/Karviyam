...
export default function DesktopSidebarLeft() {
  ...
  return (
    <aside className="w-[210px] xl:w-[230px] flex-shrink-0 flex flex-col gap-3">
      ...
      <div className="w-full h-[72px] bg-[#FFF0F2] border border-red-200/90 rounded-xl p-3 flex items-center justify-between shadow-xs overflow-hidden relative">
        <div className="flex flex-col justify-center">
          <span className="font-display font-black text-xs xl:text-sm text-[#B71C1C] uppercase tracking-wide">
            EXTRA 5% OFF
          </span>
        ...
        <div className="w-9 h-9 rounded-xl bg-red-100/80 border border-red-200 text-[#B71C1C] flex items-center justify-center font-black text-sm shadow-2xs">
          %
        </div>
      </div>
