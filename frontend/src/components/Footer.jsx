...
<p>Your privacy is paramount. We collect personal information solely to process orders, improve delivery, and send requested notifications. We never sell your data to third parties.</p>`,
  ...
  return (
    <footer className="bg-white border-t border-slate-200 text-slate-700 font-sans">
          ...
          <Link to="/" className="inline-flex items-center gap-2.5">
            {footerConfig.logoUrl && isValidImageUrl(footerConfig.logoUrl) && !logoFailed ? (
              ...
              <div className="flex items-center gap-2.5">
                <div className="w-10 h-10 rounded-2xl bg-gradient-to-tr from-[#D32F2F] to-[#B71C1C] text-white flex items-center justify-center font-black shadow-md">
                ...
                <span className="font-display font-black text-2xl tracking-tight text-[#B71C1C] uppercase leading-none">
      ...
      <div className="bg-slate-50 border-t border-slate-200 py-4 px-4 text-center text-xs sm:text-sm text-slate-600 font-medium">
