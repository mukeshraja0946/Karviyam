...
export default function CreateReviewModal({ isOpen, onClose, productId, product, order, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
      <div className="bg-white w-full max-w-xl rounded-xl shadow-2xl overflow-hidden border border-slate-200 my-4 font-sans text-left max-h-[92vh] flex flex-col animate-in zoom-in-95 duration-150">
        ...
        {/* Form Body */}
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-3.5 text-slate-900 overflow-y-auto">
          ...
          <div className="-mx-4 sm:-mx-5 -mb-4 sm:-mb-5 mt-3.5 px-4 sm:px-5 py-2.5 bg-[#F8F9FA] border-t border-slate-200 flex items-center justify-end shrink-0">
            <button
              type="submit"
              disabled={submitting}
